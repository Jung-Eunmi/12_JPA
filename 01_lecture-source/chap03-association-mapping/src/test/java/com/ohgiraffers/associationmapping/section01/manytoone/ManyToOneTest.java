...
public class ManyToOneTest {
    ...
    *   [ex] 하나의 카테고리가 여러 개의 메뉴를 가질 수 있는 상황에서 메뉴가 카테고리를 참조
    *        따라서 이 때 Menu-Many , Category-One */
    
    /* comment.
    *   연관관계 형성 된 엔티티를 조회하는 방법
    ...
    *   메뉴 엔티티를 insert 시 PERSIST 속성으로 인해 카테고리 엔티티도 insert 를 시켜야한다는 의미이다.
    * */
